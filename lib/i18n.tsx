...
const M = {
  ...
  "cases.1.industry": { en: "Real Estate", ar: "العقارات", fa: "املاک" },
  "cases.1.title": {
    en: "Property Website Built for Trust and Lead Capture",
    ar: "موقع عقاري مبني للثقة والتقاط العملاء",
    fa: "وب‌سایت املاک ساخته‌شده برای اعتماد و جذب لید",
  },
  "cases.1.desc": {
    en: "Designed to present listings, developer credibility, project details, and inquiry paths in a more professional and conversion-focused way.",
    ar: "مصمّم لعرض القوائم ومصداقية المطوّر وتفاصيل المشاريع ومسارات الاستفسار بطريقة أكثر احترافية وتركيزاً على التحويل.",
    fa: "طراحی‌شده برای ارائه‌ی آگهی‌ها، اعتبار سازنده، جزئیات پروژه و مسیرهای پرس‌وجو به شکلی حرفه‌ای‌تر و تبدیل‌محورتر.",
  },
  "cases.2.industry": { en: "Clinic / Healthcare", ar: "عيادة / رعاية صحية", fa: "کلینیک / سلامت" },
  "cases.2.title": {
    en: "Clinic Website Built for Trust and Appointment Booking",
    ar: "موقع عيادة مبني للثقة وحجز المواعيد",
    fa: "وب‌سایت کلینیک ساخته‌شده برای اعتماد و رزرو نوبت",
  },
  "cases.2.desc": {
    en: "Designed to present services, doctor credibility, patient trust signals, and clear booking paths.",
    ar: "مصمّم لعرض الخدمات ومصداقية الأطباء وإشارات ثقة المرضى ومسارات حجز واضحة.",
    fa: "طراحی‌شده برای ارائه‌ی خدمات، اعتبار پزشک، نشانه‌های اعتماد بیمار و مسیرهای روشن رزرو.",
  },
  "cases.3.industry": { en: "B2B Consulting", ar: "استشارات B2B", fa: "مشاوره B2B" },
  "cases.3.title": {
    en: "B2B Website Built for Credibility and Inquiries",
    ar: "موقع B2B مبني للمصداقية والاستفسارات",
    fa: "وب‌سایت B2B ساخته‌شده برای اعتبار و پرس‌وجو",
  },
  "cases.3.desc": {
    en: "Created to help a consulting business present services, company trust, and professional inquiry channels.",
    ar: "أُنشئ لمساعدة شركة استشارات على عرض خدماتها وثقة الشركة وقنوات استفسار احترافية.",
    fa: "ساخته‌شده برای کمک به یک کسب‌وکار مشاوره‌ای در ارائه‌ی خدمات، اعتماد شرکتی و کانال‌های پرس‌وجوی حرفه‌ای.",
  },
  "cases.4.industry": { en: "Personal Brand", ar: "علامة شخصية", fa: "برند شخصی" },
  "cases.4.title": {
    en: "Personal Brand Hub Built for Lead Generation",
    ar: "مركز علامة شخصية مبني لتوليد العملاء",
    fa: "هاب برند شخصی ساخته‌شده برای تولید لید",
  },
  "cases.4.desc": {
    en: "Organized scattered content, offers, and contact paths into one clear website funnel for audience conversions.",
    ar: "نظّم المحتوى المبعثر والعروض ومسارات التواصل في قمع موقع واحد واضح لتحويل الجمهور.",
    fa: "محتوای پراکنده، پیشنهادها و مسیرهای تماس را در یک قیف وب‌سایت روشن برای تبدیل مخاطب سازمان‌دهی کرد.",
  },
