...
export const Route = createFileRoute("/insights")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Insights — Zakeri Labs" },
...
const ARTICLES = [
  { title: "Why a Website Needs a Growth System", excerpt: "Design alone does not create leads.", hue: 220 },
  { title: "What AI Search Means for Business Websites", excerpt: "Discovery is changing.", hue: 260 },
  { title: "How to Build Trust on a Landing Page", excerpt: "Trust comes from clarity and proof.", hue: 200 },
  { title: "SEO vs AEO vs GEO", excerpt: "Modern visibility needs more than keywords.", hue: 30 },
  { title: "Why Most Websites Don't Convert", excerpt: "Weak offers and unclear CTAs lose leads.", hue: 350 },
  { title: "Plan Before You Design", excerpt: "Strategy creates better websites than decoration.", hue: 280 },
];
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      ...
      <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {ARTICLES.map((a, i) => (
          <Card key={i} className="glass-card group cursor-pointer overflow-hidden border-0 p-0 transition hover:shadow-[var(--shadow-elegant)]">
            <div
            ...
            />
            <div className="p-5">
              <span className="text-[10px] font-semibold uppercase tracking-wider text-primary">Insight</span>
